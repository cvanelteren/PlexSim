...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "plexsim.tests.cy_tests",
        "sources": [
            "plexsim/tests/cy_tests.pyx"
        ]
    },
    "module_name": "plexsim.tests.cy_tests"
}
END: Cython Metadata */
...
#define __PYX_HAVE__plexsim__tests__cy_tests
#define __PYX_HAVE_API__plexsim__tests__cy_tests
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
struct __pyx_t_7plexsim_5tests_8cy_tests_Agent;

/* "plexsim/tests/cy_tests.pyx":10
...
/* Module declarations from "plexsim.tests.cy_tests" */
#if !CYTHON_COMPILING_IN_LIMITED_API
#endif
static std::unordered_map<long,struct __pyx_t_7plexsim_5tests_8cy_tests_Agent>  __pyx_v_7plexsim_5tests_8cy_tests_Agents;
static struct __pyx_t_7plexsim_5tests_8cy_tests_Agent __pyx_v_7plexsim_5tests_8cy_tests_agent;
static std::vector<long *>  __pyx_v_7plexsim_5tests_8cy_tests_test;
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "plexsim.tests.cy_tests"
extern int __pyx_module_is_main_plexsim__tests__cy_tests;
int __pyx_module_is_main_plexsim__tests__cy_tests = 0;

/* Implementation of "plexsim.tests.cy_tests" */
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    if (!(likely(PyTuple_CheckExact(__pyx_t_3))||((__pyx_t_3) == Py_None) || __Pyx_RaiseUnexpectedTypeError("tuple", __pyx_t_3))) __PYX_ERR(1, 773, __pyx_L1_error)
...
if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__Pyx_InitString(__pyx_string_tab[3], &__pyx_kp_u_Non_native_byte_order_not_suppor) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[4], &__pyx_n_s_RuntimeError) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[9], &__pyx_n_s_i) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[10], &__pyx_n_s_import) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[11], &__pyx_n_s_initializing) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[14], &__pyx_n_s_np) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[15], &__pyx_n_s_numpy) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[16], &__pyx_kp_u_numpy_core_multiarray_failed_to) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[17], &__pyx_kp_u_numpy_core_umath_failed_to_impor) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[18], &__pyx_n_s_range) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[19], &__pyx_n_s_spec) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[20], &__pyx_n_s_test) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[21], &__pyx_kp_u_unknown_dtype_code_in_numpy_pxd) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
...
static int __pyx_pymod_exec_cy_tests(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cy_tests},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcy_tests(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcy_tests(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cy_tests(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cy_tests(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cy_tests(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cy_tests' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cy_tests", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cy_tests(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_plexsim__tests__cy_tests) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "plexsim.tests.cy_tests")) {
      if (unlikely(PyDict_SetItemString(modules, "plexsim.tests.cy_tests", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 10; __pyx_t_2+=1) {
    __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    if (PyDict_SetItem(__pyx_d, __pyx_n_s_i, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "plexsim/tests/cy_tests.pyx":23
 * 
 * for i in range(10):
 *     agent.id = i             # <<<<<<<<<<<<<<
 *     agent.state = 1
 *     Agents[i] = agent
 */
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyInt_As_long(__pyx_t_1); if (unlikely((__pyx_t_3 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_7plexsim_5tests_8cy_tests_agent.id = __pyx_t_3;

    /* "plexsim/tests/cy_tests.pyx":24
 * for i in range(10):
 *     agent.id = i
 *     agent.state = 1             # <<<<<<<<<<<<<<
 *     Agents[i] = agent
 ...
 */
    __pyx_v_7plexsim_5tests_8cy_tests_agent.state = 1;

    /* "plexsim/tests/cy_tests.pyx":25
 *     agent.id = i
 *     agent.state = 1
 *     Agents[i] = agent             # <<<<<<<<<<<<<<
 *     test.push_back(&Agents[i].state)
 * 
 */
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyInt_As_long(__pyx_t_1); if (unlikely((__pyx_t_3 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    (__pyx_v_7plexsim_5tests_8cy_tests_Agents[__pyx_t_3]) = __pyx_v_7plexsim_5tests_8cy_tests_agent;

    /* "plexsim/tests/cy_tests.pyx":26
 *     agent.state = 1
 *     Agents[i] = agent
 *     test.push_back(&Agents[i].state)             # <<<<<<<<<<<<<<
 * 
 * 
 */
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_i); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyInt_As_long(__pyx_t_1); if (unlikely((__pyx_t_3 == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    try {
      __pyx_v_7plexsim_5tests_8cy_tests_test.push_back((&(__pyx_v_7plexsim_5tests_8cy_tests_Agents[__pyx_t_3]).state));
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 * 
 */
  (__pyx_v_7plexsim_5tests_8cy_tests_Agents[1]).state = 3;

  /* "plexsim/tests/cy_tests.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init plexsim.tests.cy_tests", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_COMPILING_IN_LIMITED_API
    Py_CLEAR(__pyx_m);
    #endif
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init plexsim.tests.cy_tests");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
